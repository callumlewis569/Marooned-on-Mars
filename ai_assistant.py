...
oil = 3
inventory = [
                {"item": "basic potatoes", "number": basic_potatoes, "solves": "hunger, oxygen (by replanting)"},
                {"item": "mars potatoes", "number": mars_potatoes, "solves": "hunger (best option for food)"},
                {"item": "tree potatoes", "number": tree_potatoes, "solves": "oxygen (best option for planting for oxygen)"},
                {"item": "ice blocks", "number": ice, "solves": "thirst"},
                {"item": "coal", "number": coal, "solves": "fuel"},
                {"item": "ice blocks", "number": ice, "solves": "fuel"}
                ]
